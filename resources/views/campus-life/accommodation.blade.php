 ...
 <section class="breadcrumbs">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <h1 style="text-transform:uppercase;">Accommodation</h1>
            <ol>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                <div class="capusLife">
                    ...
                    <div class="service-content">
                        ...
                        <p class="description"> DIU officers well-decorated hotels with modern facilities. At present there are six boys hostel and one girls' hostel.</p>
                    </div>
                    <img src="{{ asset('assets/img/campuslife/2.jpg') }}" alt="Outdoor-Activities" /> 
                </div>
            </div>
