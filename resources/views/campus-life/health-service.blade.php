 ...
 <section class="breadcrumbs">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <h1 style="text-transform:uppercase;">Health Service</h1>
            <ol>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                <div class="capusLife">
                    <div class="service-icon">
                        <span><i class="fa fa-medkit" aria-hidden="true"></i></i></span>
                    </div>
                    <div class="service-content">
                        <h3 class="title">Health Service</h3>
                        <p class="description">Dhaka international University has health services department . Doctors are available in all campuses . They consult the students with their health related problems.</p>
                    </div>
