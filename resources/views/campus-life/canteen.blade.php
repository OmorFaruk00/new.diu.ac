 ...
 <section class="breadcrumbs">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <h1 style="text-transform:uppercase;">Canteen & Common Rooms </h1>
            <ol>
                <li><a href="{{ route('home') }}">Home</a> </li>
                <li>Campus Life</li>
                <li>Canteen & Common Rooms </li>
            </ol>
        </div>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                <div class="capusLife">
                    ...
                    <div class="service-content">
                        <h3 class="title">Canteen & Common Rooms </h3>
                        <p class="description">DIU has its own catering service and each building has big common & leisure rooms.</p>
                    </div>
