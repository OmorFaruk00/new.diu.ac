...
.main-club .club:nth-child(7){ --main-color: #0d897f; }
.main-club .club:nth-child(8){ --main-color: #ba2eed; }
.main-club .club:nth-child(9){ --main-color: #1bd9a7; }
                ...
                <div class="container my-4">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-club">
                                ...
                                <div class="club">
                                    <a href="#" class="club-content">
                                        <h3 class="title">DIU Career Development Club</h3>
                                        <p class="description">
                                            Career development plans are needed things for the students. A plan that helps you do better for your long-term career. DIU Career and Skills Development Club helps you to pursue these skills efficiently.
                                        </p>
                                    </a>
                                </div>
                                <div class="club">
                                    <a href="#" class="club-content">
                                        <h3 class="title">DIU Young Entrepreneur Club</h3>
                                        <p class="description">
                                            To enhance the power of leadership skills, gain in-depth knowledge of the corporate world, and prepare yourself for future journeys through club activities.
                                        </p>
                                    </a>
                                </div>
                                <div class="club">
                                    <a href="#" class="club-content">
                                        <h3 class="title">DIU Reading and Research Club</h3>
                                        <p class="description">
                                            Reading helps you improve your grammar and skills, and it also helps you communicate and think more articulately. If someone wants to see himself or herself in the world of research, a small step awaits them.
                                        </p>
                                    </a>
                                </div>               
                    ...
                    <div class="row" class="">
                        <div class="col-xl-3 col-md-3 col-sm-6">
                            <a href="https://cdc.diu.ac.bd" target="_blank">
                                <img src="{{asset('/assets/images/club/cdc.jpg')}}" alt="logo" style="height: 250px">
                            </a>
                        </div>
                        <div class="col-xl-3 col-md-3 col-sm-6">
                            <a href="https://yec.diu.ac.bd" target="_blank">
                            <img src="{{asset('/assets/images/club/yec.png')}}" alt="logo" style="height: 150px;margin-top:50px">
                        </a>
                        </div>
                        <div class="col-xl-3 col-md-3 col-sm-6">
                            <a href="https://rrc.diu.ac.bd" target="_blank">
                            <img src="{{asset('/assets/images/club/rrc.jpg')}}" alt="logo" style="height: 250px">
                        </a>
                        </div>
                    </div>
