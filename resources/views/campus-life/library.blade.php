    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h1 style="text-transform:uppercase;">Libray</h1>
                <ol>
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 mx-auto">
                    <div class="capusLife">
                        ...
                        <div class="service-content">
                            ...
                            <p class="description">DIU library is equipped with up-to-date books and reading materials. More
                                than fifty (50)
                                thousand books are available at DIU libraby. E-library has already been started.</p>
                        </div>
