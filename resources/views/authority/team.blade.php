    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <h1 style="text-transform:uppercase;"> {{ str_replace('-', ' ', $type ?? 'NA') }} </h1>
                <ol>
                    <li><a href="{{ route('home') }}">Home</a></li>
                    <li> Authority </li>
                    <li style="text-transform: capitalize"> {{ str_replace('-', ' ', $type ?? 'NA') }}  </li>
                </ol>
            </div>
                ...
                <div class=" col-lg-6  col-md-6 col-sm-12 mb-4" v-for="(item,index) in teams" :key="index">
                    <div class="team">
                        <div class="signature-icon">
                            <img :src="item.profile_image" alt="profile pic">
                        </div>
                        ...
                        <ul class="signature-content">
                            ...
                            <li><span class="fa fa-envelope"></span> <strong v-text="item.email"></strong></li>
                           
                            <li><span class="fa fa-map-marker"></span> <strong> Satarkul, Badda, Dhaka-1212.</strong></li>
                           
                        </ul>
                        <ul class="icon">
                            <a :href="`https://api.whatsapp.com/send?phone=88${item.phone.slice(-11)}`"  class="whats-btn" target="_blank">
                                <i class="fa fa-whatsapp" aria-hidden="true"></i> WhatsApp
                            </a>
                      
                            <a :href="item.profile_link" class="profile-btn" target="_blank">View Profile</a>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            var vue = new Vue({
                ...
                methods: {
                    getData() {
                        var vm = this;
                        axios.get(`${vm.config.base_path}/public-diu-website/authority-team/${this.type}`)
                            .then((
                                response) => {
