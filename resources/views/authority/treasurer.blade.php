    ...
    <section class="breadcrumbs">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <h1 style="text-transform: uppercase">Treasurer</h1>
                <ol>
            ...
            <div class="container">
                <div class="authority">
                    ...
                    <ul class="signature-content">
                        ...
                        <li><i class="fa fa-envelope"></i> treasurer.diu@diu.ac</li>
                        <li><i class="fas fa-map-marker-alt"></i>Office of the Treasurer, Permanent Campus: Satarkul, Badda, Dhaka-1212.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-5">
            <div class="message">
                <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit quia alias ipsa cum
                    ...
                    <a class="profile" href="/existing-student-help/treasurer-office">Browse Office Personnel</a>
            </div>
        </div>
    </section>
@endsection
