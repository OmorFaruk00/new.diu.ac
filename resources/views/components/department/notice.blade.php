...
<div v-if="notices && notices.length"  style="background: #" class="notice-bg" id="noticeEvent">
    <div class="container " >
        <section id="section4">
            <div class="">
                <div class="row g-0">
                        ...
                        <div class="enchance">
                            <div class="row" v-for="notice in notices" :key="notice.id">
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    <p class="notice-date" v-text="notice.created_at.slice(0, 10)"></p>
                                </div>
                                <div class=" col-lg-9 col-md-6 col-sm-12">
                                    <a :href="'/program-notice-details/'+ notice.slug">
        ...
        var vue = new Vue({
            ...
            methods: {
                getNotices() {
                    ...
                    axios.get(
                            `${vm.config.base_path}/public-diu-website/department-notice/${this.slug}`
                            )
                        .then((
                            response) => {
